# -*- coding: utf-8 -*-
#
# datalad_openneuropet documentation build configuration file, created by
        ...
        try:
            subprocess.run(
                args=[setup_py_path, 'build_manpage',
                     '--cmdsuite', 'datalad_openneuropet:command_suite',
                     '--manpath', abspath(opj(
...
# built documents.
version = datalad_openneuropet.__version__
release = version
